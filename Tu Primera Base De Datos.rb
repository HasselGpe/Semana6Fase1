...
# );
# El siguiente artículo explica los tipos de datos de SQLite como VARCHAR, DATETIME, INTEGER, etc.
...
#Paso 1: Crear la base de datos
CodeaCamp10s-Mac-mini:Semana 6 codea_mac_10$ sqlite3 ejemplo.db
# SQLite version 3.8.5 2014-08-15 22:37:57
# Enter ".help" for usage hints.
...
sqlite> INSERT INTO usuarios
   ...> (nombre, apellido, email, fecha_nacimiento, genero)
   ...> VALUES
   ...> ('Hassel', 'Ortega', 'hassel.ortegapelaez@hotmail.com', '1995-02-06', 'femenino');
sqlite> SELECT * FROM usuarios;   

id          nombre      apellido    email             fecha_nacimiento  genero    
----------  ----------  ----------  ----------------  ----------------  ----------
1           Carlos      Ribero      carlos@yahoo.com  1970-11-03        masculino 
2           Hassel      Ortega      hassel@yahoo.com  1995-02-06        Femenino  

#Paso 4: Comandos multilínea
# Todos los comandos de SQL deben terminar en ;. Podemos introducir comandos de más
#  de una línea y SQLite solamente los ejecutará hasta que introducimos un ;.

# Fíjate como los ejemplos de arriba usan esto para separar las sentencias de SQL y sean más fáciles
#  de leer.

#Paso 5: Errores   
# Intenta volver a insertar otro registro con la misma información de Carlos Ribero.
# ¿Qué significa el error que se muestra? Busca en qué parte de las sentencias anteriores le indicamos 
# a nuestra tabla de usuarios que tenga este comportamiento. ¿Para qué son útiles este tipo 
# de validaciones?

#Paso 6: Agregar una columna
sqlite> ALTER TABLE usuarios
   ...> ADD apodo VARCHAR(64) NOT NULL default('');
sqlite> SELECT * FROM usuarios;
...
sqlite> .schema
# El comando .schema muestra el esquema de la tabla. Verifica
#  que se halla agregado la columna correctamente.
...
CREATE TABLE usuarios (
  ...
  fecha_nacimiento DATETIME NOT NULL,
  genero VARCHAR(10) NOT NULL
, apodo VARCHAR(64) NOT NULL default(''));
...
2           Hassel      Ortega      hassel@yahoo.com  1995-02-06        Femenino    Hass      
